...
[Webhook](https://discord.com/developers/docs/resources/webhook) module of [disgo](https://github.com/x1xo/disgo)
...
```go
import "github.com/x1xo/disgo/webhook"
```
...
a full example can be found [here](https://github.com/x1xo/disgo/tree/master/_examples/webhook/example.go)